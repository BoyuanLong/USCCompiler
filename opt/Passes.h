...
struct LICM : public LoopPass
{
    ...
    virtual bool isSafeToHoistInstr(llvm::Instruction* instruction);
    
    virtual void hoistInstr(llvm::Instruction* instr);
    
    virtual void hoistPreOrder(llvm::DomTreeNode* node);
